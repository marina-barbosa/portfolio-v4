...
//   {
//     id: 1,
//     name: `Sprawl – E-commerce de Kimonos`,
//     image: "/sprawl.png",
//     technologies: [
...
//     ],
//     description: `
//     Atuo como Desenvolvedora Fullstack Voluntária na Sprawl, 
//     um e-commerce de kimonos, 
//     contribuindo com o desenvolvimento backend em ExpressJS e frontend em ReactJS. 
//     Participo da implementação de APIs RESTful para gerenciamento de produtos, 
//     pedidos e transações, 
//     além da criação de uma interface intuitiva para os usuários. 
//     Também colaboro na integração de funcionalidades essenciais de e-commerce, 
//     como autenticação, carrinho de compras e processamento de pedidos, 
//     além do desenvolvimento do painel administrativo para gestão de produtos, 
//     pedidos e clientes. A plataforma utiliza PostgreSQL como banco de dados 
...
//     ],
//     description: `
//     Refood é uma plataforma que permite que 
//     estabelecimentos comerciais vendam produtos próximos da data de validade 
//     a preços acessíveis, ajudando a reduzir o desperdício de alimentos. 
//     Como desenvolvedora fullstack, contribuí para a implementação do backend 
//     com Java 17 e Spring Boot, utilizando PostgreSQL para armazenamento de dados 
//     e Firebase para armazenamento de arquivos. 
//     No frontend, desenvolvi interfaces modernas e responsivas com 
//     React, Vite, Tailwind e Shadcn/ui. 
//     O sistema conta com autenticação segura via OAuth2 e JWT, 
//     gerenciamento de restaurantes, produtos e pedidos, 
//     integração com CEPs para entrega, 
//     além de documentação interativa da API com Swagger.`,
//     viewLink: null,
...
//     ],
//     description: `
//     NTT Movie Data é uma aplicação SPA (Single Page Application) 
//     desenvolvida como teste de Front-End, 
//     permitindo a busca de informações detalhadas sobre filmes e séries. 
//     Além de visualizar temporadas e episódios, os usuários podem marcar títulos como favoritos. 
//     O projeto foi desenvolvido com Angular, Bootstrap e SCSS, 
//     utilizando Firebase Store para armazenamento de dados e autenticação via Google. 
//     A aplicação consome a OMDb API para exibição de informações sobre filmes e séries, 
//     e a MyMemory API para traduções automáticas de títulos e descrições.`,
